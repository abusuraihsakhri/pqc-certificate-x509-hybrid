"""
Automated Pytest for pqc-certificate-x509-hybrid Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    Pqccertificatex509hybridEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = Pqccertificatex509hybridEnrichmentSuite()
