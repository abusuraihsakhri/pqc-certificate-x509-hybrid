...
import pytest
from pqc_x509_pki.models import FrontierPayload, ExecutionStatus
from pqc_x509_pki.engine import FrontierDomainEngine
from pqc_x509_pki.agents import CompositePublicKeyEncoderAgent, DualSignatureVerifierAgent, PKIXValidationEngineAgent, PQCX509Coordinator
from pqc_x509_pki.cli import main


def test_sub_agents():
    a1 = CompositePublicKeyEncoderAgent()
...
def test_coordinator():
    ...
    assert "IETF LAMPS Composite PQC Certificates" in ans or "specifications" in ans
