"""
FastAPI REST API Server for PQC-X509: Hybrid Post-Quantum PKI Certificate Parser & Authority Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="PQC-X509: Hybrid Post-Quantum PKI Certificate Parser & Authority Agent",
            description="Issues and verifies composite X.509 certificates containing dual classical (ECDSA/RSA) and post-quantum (ML-DSA/Falcon) public keys per IETF LAMPS drafts.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "pqc-certificate-x509-hybrid", "domain": "Post-Quantum Cryptography & Zero-Knowledge", "version": "2.0.0-FRONTIER"}
